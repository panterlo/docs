...
## A word about dates, unix epoch and YYYY-MM-DDTHH:mm:ss

Typesense allows only unix dates to be indexed so when you see a unix epoch timestamp it means it's an indexed field. All other
dates are returned in YYYY-MM-DDTHH:mm:ss format.
