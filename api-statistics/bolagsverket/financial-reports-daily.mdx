---
title: 'Bolagsverket Financial Reports Daily'
openapi: get /statistics/se/bolagsverket/financial-reports/daily
---
...
The format is an array of arrays with the type [Int32,Int32] with the first representing YYMMDD
...
found for the same date as the registered financial report.
