...
they are placed in the financial report.
...
The keymetrics are calculated according to the following.
...
Changes to calulcation may occur since different actors are interpreting data differently for km_NetProfitMargin.
