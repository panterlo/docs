...
In countries such as Sweden the mandatory audit requirement for businesses was removed in 2010
which allows businesses under certain thresholds to save money by not having an auditor. This
has created new challenges which has remained unsolved by our competitors. Companies can
submit financial statements and annual reports that contains any made up numbers and authorities
have very littile possibilities to detect these.
  ...
  "intelligence": [
    {
      ...
      "notes": "The annual report for 2021-01-01 till 2021-12-31 is
...
## How common is financial statement frauds

We have learned by looking at discrepancies for the last ten years that financial statement frauds are
more common in businesses that lacks auditor requirements but do exist in both. It's easy to create a new
business, submit a fradulent financial report with good looking number and get a descent credit score
ranking by existing credit reference agencies. The companies are then used to receive contributions
...
This demonstrates the problem that these companies ultimatley are controlled by other individuals.
